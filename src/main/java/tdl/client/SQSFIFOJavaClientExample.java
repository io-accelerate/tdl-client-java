...
public class SQSFIFOJavaClientExample {
    public static void main(String[] args) {
         ...
         */
        String serviceEndpoint = String.format("http://%s:%d", "localhost", 28161);
        final AmazonSQS sqs = createAWSClient(
                serviceEndpoint,
                "elasticmq",
                "local_test_access_key",
        ...
        try {
            ...
            final CreateQueueRequest createQueueRequest =
                    new CreateQueueRequest("MyFifoQueue")
//                    new CreateQueueRequest("MyFifoQueue.fifo")
            ...
            do {
                batch = sqs.receiveMessage(receiveMessageRequest);
